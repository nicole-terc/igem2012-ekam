...
class JElementColor extends JElement
{
	...
	{
		ob_start();
		$img=JUri::root()."templates/joomspirit_35/images/rainbow/rainbow.png";
		$imgx=JUri::root()."templates/joomspirit_35/images/rainbow/";
		static $embedded;
				if(!$embedded)
		{
			$css2=JUri::root()."templates/joomspirit_35/css/mooRainbow.css";
			$jspath=JUri::root()."templates/joomspirit_35/lib/js/mooRainbow.js";
			 ?>
<link
